							...
							<div class="col-md-5" id="f_panel">
								<div class="card m-t-10">
									...
									<div class="card-body">
										...
										<?php
										$action_path = "contact/insert_contact";
										?>
										...
										<form enctype="multipart/form-data" id="add_name" class="row  needs-validation" novalidate method="POST" action="<?php echo base_url() . $action_path ?>">
											...
											<div class="col-md-6 my-3 form-floating ">
												<input type="Number" class="form-control" name="Landline" id="floatingInput" placeholder="name@example.com" required>
												<label for="validationTooltip01" class="form-label">Landline</label>
												<div class="valid-tooltip">Looks good!</div>
												<div class="invalid-tooltip">This Field Is Required!</div>
											</div>
											<div class="col-md-6 my-3 form-floating ">
												<input type="Number" class="form-control" name="Cell" id="floatingInput" placeholder="name@example.com" required>
												<label for="validationTooltip01" class="form-label">Cell</label>
												<div class="valid-tooltip">Looks good!</div>
												<div class="invalid-tooltip">This Field Is Required!</div>
											</div>
											...
											<div class="col-md-12 my-2 form-floating ">
												<textarea class="form-control" style="height:100px ;" name="Address" placeholder="Leave a Detail here" id="floatingTextarea2" required></textarea>
											...
											<div class="col-md-12 my-4 form-floating ">
												<input type="text" class="form-control" name="Map" id="floatingInput" placeholder="name@example.com" required>
												<label for="validationTooltip01" class="form-label">Map</label>
												<div class="valid-tooltip">Looks good!</div>
												<div class="invalid-tooltip">This Field Is Required!</div>
											</div>

											<div class="col-md-12   text-center">
												<button class="btn btn-danger" href="<?php echo base_url()?>home" id="cancel" type="reset"> Cancel</button>
													...
													?>
														<tr>
															...
															<td class="text-center ">
																<a data-toggle="modal" data-target="#del" class="edit_btn btn btn-info btn-sm"><i class="fa fa-eye"></i> Map</a>
															</td> 
