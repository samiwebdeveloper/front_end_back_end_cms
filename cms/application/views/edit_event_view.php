							...
							<div class="col-md-5" id="f_panel">
								<div class="card m-t-10">
									...
									<div class="card-body">
										...
										<?php
										$action_path = "Event_Controller/edit_master_detail_row";
											...
											<div class="col-md-12 my-3 form-floating ">
												...
												<table class="table table-bordered">
													...
													?>
														...
														<tr id="row<?php echo $EventImageId; ?>">
															...
															<td class="text-center"><button type="button" name="remove" id="<?php echo $EventImageId ?>" class="btn btn-danger btn_remove">X</button></td>

														</tr>

													<?php } ?>
													<tr id="dynamic_field">
														<td class="text-right" colspan="3"><button type="button" name="add" id="add" class="btn btn-success ">+</button></td>
