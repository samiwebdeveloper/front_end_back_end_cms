...
<body class="fixed-header menu-pin menu-behind">
  <div class="login-wrapper " style="background-color:#6d5eac">
    ...
    <div class="bg-pic">
      ...
      <!-- <img src="<?php echo base_url(); ?>assets/bg.png" data-src="<?php echo base_url(); ?>assets/bg.png" data-src-retina="<?php echo base_url(); ?>assets/bg.jpg" alt="" class="lazy"> -->
      <!-- END Background Pic-->
    ...
    <div class="login-container bg-white">
      <img style="margin-left:40px ;margin-top:10px;"  src="<?php echo base_url(); ?>assets/bg.png" data-src="<?php echo base_url(); ?>assets/bg.png" data-src-retina="<?php echo base_url(); ?>assets/bg.jpg" width="80%">
      <!-- START Login Form -->
      <div class="mx-5 my-1">
            ...
            <?php if (!empty($error)) {
              if ($error == "Y") { ?>
                <div class="alert alert-danger alert-dismissible">
                  ...
                  Username and password must not be null.Please try again.
                </div>
              <?php } else if ($error == "YN") { ?>
                <div class="alert alert-danger alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                  Worng username or password.Please try again.
                </div>
            <?php }
            } ?>
