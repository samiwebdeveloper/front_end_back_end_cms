									...
									<div class="card-body">
										...
										<form enctype="multipart/form-data" id="add_name" class="row  needs-validation" novalidate method="POST" action="<?php echo base_url() . $action_path ?>">
											...
											?>
												...
												<div class="col-md-12 my-3 form-floating ">
													<input type="text" class="form-control" name="type" id="floatingInput" value="<?php echo $Type; ?>" required>
											...
											<?php } else { ?>
												...
												<div class="col-md-12 my-3 form-floating ">
													<input type="text" class="form-control" name="type" id="floatingInput" value="<?php echo $Title; ?>" required>
													<label for="validationTooltip01" class="form-label">Type</label>
													<div class="valid-tooltip">Looks good!</div>
													<div class="invalid-tooltip">This Field Is Required!</div>
												</div>
